  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <button
          onClick={onExport}
          className={`flex flex-col items-center p-6 border-2 border-neutral-200 rounded-2xl hover:bg-neutral-50 transition-all group ${createFocusEffect.input('md', 'primary')}`}
        >
      ...
      {/* Danger Zone */}
      <div className="pt-6 border-t border-neutral-200 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <button
            onClick={onDeleteAll}
            className={`flex flex-col items-center p-6 border-2 border-red-200 rounded-2xl hover:bg-neutral-50 transition-all group ${createFocusEffect.input('md', 'primary')}`}
          >
